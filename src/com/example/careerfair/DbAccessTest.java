...
public class DbAccessTest extends AndroidTestCase {
	...
	protected void setUp() throws Exception 
	{
		...
		ExternalDbOpenHelper helper = new ExternalDbOpenHelper(getContext(), "careerFairDB.db" );
	...
	public void testGetCompaniesWith() {
		ArrayList<Company> companies = DbAccess.getCompaniesWith("", "", new ArrayList<String>(), new ArrayList<String>(), new ArrayList<String>(), database);
	...
	public void testGetAllMajors() {
		...
		ArrayList<Major> majorsByAbbrev = DbAccess.getAllMajors(database, false);
